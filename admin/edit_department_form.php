   <div class="row-fluid">
    <a href="department.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Department</a>
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<form method="post" action="update_department_action.php">
    ...
    <select name="hod" required>
        ...
        while ($teacher_row = mysqli_fetch_array($teacher_query)) {
            $selected = ($teacher_row['teacher_id'] == $row['hod_id']) ? "selected" : "";
            echo "<option value='" . $teacher_row['teacher_id'] . "' $selected>" . $teacher_row['firstname'] . " " . $teacher_row['lastname'] . "</option>";
        }
        ?>
    </select>

			<form id="login_form1" class="form-signin" method="post">
						<h3 class="form-signin-heading"><i class="icon-lock"></i> Sign Up</h3>
						<input type="text" class="input-block-level" id="username" name="username" placeholder="Username / ID number" required>
						...
						jQuery("#login_form1").submit(function(e){
								...
								$.ajax({
									...
									$.jGrowl("Welcome to KSUSTA Learning Management System", { header: 'Access Granted' });
									var delay = 1000;
